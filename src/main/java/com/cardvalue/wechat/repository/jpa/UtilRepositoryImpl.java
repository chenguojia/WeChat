...
import com.cardvalue.wechat.model.StartupImage;
import com.cardvalue.wechat.model.UserStartupImage;
...
public class UtilRepositoryImpl implements UtilRepository{
	...
	public String getBranchLabelByCode(String code){
		Query findBranchLabelByCodeQuery = em.createNamedQuery("findBranchLabelByCode")
	...
	public String getRegionLabelByCode(String code){
		Query findBranchLabelByCodeQuery = em.createNamedQuery("findRegionLabelByCode")
				.setParameter("code", code);
		String name = "";
		try {
			name = (String)findBranchLabelByCodeQuery.getSingleResult();
