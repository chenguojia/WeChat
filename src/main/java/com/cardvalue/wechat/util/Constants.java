...
public class Constants {
	...
	//支付通
	public final static int USER_TYPE_ZFT_SALES = 20;
	...
	//用户操作类型，用于记录操作日志
	public final static int ACTION_LOG_IN = 1;
	...
	public final static int ACTION_CREATE_LEADS = 9;
	public final static int ACTION_ADD_MERCHANT = 10;
	public final static int ACTION_MAKE_LOAN = 11;
	public final static int ACTION_EXTRA_POINT = 12;
	public final static int ACTION_CLICK_BANNER = 13;//银联商户点击banner
	...
	//机构
	//银联
	public final static String PROCESSOR_ID_UMS = "301";
	//卡得万利
	public final static String PROCESSOR_ID_CV = "331";
	//通联
	public final static String PROCESSOR_ID_ALLINPAY = "332";
	//银盛
	public final static String PROCESSOR_ID_YS = "329";
	//待确定
	...
	/**报表文件导出格式*/
	public final static String EXPORT_REPORT_TYPE_XLS = "xls";
	public final static String EXPORT_REPORT_TYPE_PDF = "pdf";
	public final static String EXPORT_REPORT_TYPE_CSV = "csv";
	public final static String EXPORT_REPORT_TYPE_HTML = "html";
