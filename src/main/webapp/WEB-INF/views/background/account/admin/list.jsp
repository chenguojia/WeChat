...
<div class="panel-heading">
    ...
    <form name="form1" class="clearfix" id="form1" action="<c:url value="/report/exportReport"/>"
        ...
        <div class="input-group" style="float: right">
            <button class="btn btn-primary showModalBtn" type="button" url="<c:url value="/background/${moduleName}/new" />" style="margin-right: 5px;">新增</button>
            <button class="btn btn-danger batchDellBtn " type="button" url="<c:url value="/background/${moduleName}/new" />" parentUrl="<c:url value="/background/${moduleName}/init"/>">删除</button>
        </div>
    </form>
</div>
