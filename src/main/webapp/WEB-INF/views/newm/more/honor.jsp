    ...
    <div class="view view-main">
        ...
        <div class="navbar" style="display: ${isApp == '0' ? 'block' : 'none'}">
            <div class="navbar-inner">
                ...
                <div class="center sliding">资质荣誉</div>
            </div>
        </div>
        ...
        <div class="pages navbar-through toolbar-through">
            ...
            <div data-page="index" class="page" style="background-color: #ffffff;">
                ...
                <div class="page-content page-content-scroll ${isApp == '0' ? '' : 'none-navbar'}">
                    ...
                    <div class="caseShare_pic aboutUs_titPic"><a href="#" class="caseShare-popup"><img src="<c:url value="/resources/newm/images/service-list.png"/>" width="100%"></a></div>
                    ...
                    <div class="caseShare_pic aboutUs_titPic"><a href="#" class="caseShare-popup"><img src="<c:url value="/resources/newm/images/permission-credit.png"/>" width="100%"></a></div>
                    <div class="content-block caseShare_story">
                        <span>卡得万利商业保理（上海）有限公司，是根据商务部《关于商业保理试点有关工作的通知》以及《上海市浦东新区设立商业保理企业试行办 法》设立的全国首家国家级商业保理试点企业。</span>
                    </div>
                </div>
            </div>
        </div>
