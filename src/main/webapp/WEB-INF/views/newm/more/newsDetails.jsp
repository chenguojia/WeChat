    ...
    <div class="view view-main">
        ...
        <div class="navbar"  style="display: ${isApp == '0' ? 'block' : 'none'}">
            <div class="navbar-inner">
                <div class="left"><a href="<c:url value='/new/m/more/news'/>" class="back link wechat-back"> <i class="icon icon-back card-back"></i></a></div>
                <div class="center sliding">新闻中心</div>
            </div>
        </div>
            ...
            <div data-page="index" class="page" style="background-color: #ffffff;">
                ...
                <div class="page-content ${isApp == '0' ? '' : 'none-navbar'}">
                    ...
                    <div class="content-block caseShare_story">
                        ...
                        <p><span>卡得万利商业保理(上海)有限公司(以下简称卡得万利)，以独创的保理融资的新金融模式，为小微商贸企业提供融资服务，在解决其融资需求“短、频、急”的问题上，有独到之处，小微企业若能用好用活，将立刻脱离融资“难、贵、慢”状态，从此不差钱。</span></p>
