    ...
    <div class="view view-main">
        ...
        <div class="navbar" style="display: ${isApp == '0' ? 'block' : 'none'}">
            <div class="navbar-inner">
                ...
                <div class="center sliding">案例分享</div>
            </div>
        </div>
            ...
            <div data-page="index" class="page" style="background-color: #ffffff;">
                ...
                <div class="page-content page-content-scroll ${isApp == '0' ? '' : 'none-navbar'}" id="page-content pull-to-refresh-content">
                    ...
                    <div class="content-block caseShare_story">
                        <span>2014年12月7日，正值“大雪”节气，卡得万利商业保理（上海）有限公司客户经理王浩接到一份特殊的快递：除一封手写的感谢信外，还有一些腊肉、火腿自制的土特产品。这份快递来自杭州主营红酒生意的黄先生，感谢信内容是这样的：“非常感谢王经理在关键时刻解我燃眉之急，谨寄上自制的家乡的一点土特产以表感谢！”</span>
